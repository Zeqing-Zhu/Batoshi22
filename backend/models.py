...
class Machine(db.Model):
    ...
    def init_db():
        rets = [
            ...
            (3, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98),
            (4, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98),
            (5, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98),
            (6, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98),
            (7, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98),
            (8, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98),
            (9, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98),
            (10, 'Antminer', 'S19 Pro', 1667092275.331346, 1, 88.98, 123.09, 827.98, 88.98, 123.09, 827.98)
        ]
        for ret in rets:
            machine = Machine()
